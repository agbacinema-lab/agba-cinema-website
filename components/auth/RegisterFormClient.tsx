          ...
          <CardContent className="p-0">
            ...
            <div className="flex bg-gray-100 p-1 rounded-2xl mb-6">
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-xl text-xs font-bold transition-all ${
                  role === "staff" ? "bg-white text-black shadow-sm" : "text-gray-500"
                }`}
              >
                Staff
              </button>
              <button
                ...
                className={`flex-1 py-3 rounded-xl text-xs font-bold transition-all ${
                  role === "brand" ? "bg-white text-black shadow-sm" : "text-gray-500"
                }`}
              >
                Brand
              </button>
            ...
            {(paymentRef || role !== "student") && (
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-yellow-400 text-black font-black h-14 rounded-2xl mt-4"
                >
