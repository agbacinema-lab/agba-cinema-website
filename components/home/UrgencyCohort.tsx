...
export default function UrgencyCohort() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-900 to-black relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(250,204,21,0.08)_0%,_transparent_70%)] pointer-events-none" />
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-10">
            ...
            <span className="text-white text-lg font-semibold">
              Only <strong className="text-yellow-400 text-2xl">{slotsLeft} slots</strong> remaining — out of 10
            </span>
          </div>
          ...
          <div className="max-w-sm mx-auto mb-12">
            <div className="bg-white/10 rounded-full h-3 overflow-hidden">
              <div
                ...
                style={{ width: `${((10 - slotsLeft) / 10) * 100}%` }}
              />
            </div>
            <p className="text-gray-400 text-sm mt-2">8 of 10 spots filled</p>
          </div>
